...
"$PYTHON" "${SCRIPT_DIR}"/../../../Tools/SecureBoot/generate_programmer.py --gpproductid QPG6105 --hexlink "${SCRIPT_DIR}"/../../../Work/base_qpg6105_development/base_qpg6105_development.hex --input "${SCRIPT_DIR}"/../../../Tools/SecureBoot/templates/programmer_info_k8e.tmpl --output "${SCRIPT_DIR}"/../../../Work/base_qpg6105_development/base_qpg6105_development.xml

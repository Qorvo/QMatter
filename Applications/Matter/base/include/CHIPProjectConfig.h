...
#define CHIP_DEVICE_CONFIG_DEVICE_SOFTWARE_VERSION 65794 // Can't be removed, needed for OTA file generation.
#endif
...
#define CHIP_DEVICE_CONFIG_DEVICE_SOFTWARE_VERSION_STRING "1.1.2" // Can't be removed, needed for OTA file generation.
#endif

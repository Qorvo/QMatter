...
public:
    ...
    enum TemperatureDisplayMode_t
    {
        DEGREE_C = 0,
        DEGREE_F,
    } TemperatureDisplayMode;

    typedef chip::app::Clusters::Thermostat::ThermostatControlSequence Operation_t;
    typedef chip::app::Clusters::Thermostat::ThermostatSystemMode SystemMode_t;
    ...
    uint8_t GetTemperatureDisplayMode(void);
    void SetTemperatureDisplayMode(uint8_t aMode);

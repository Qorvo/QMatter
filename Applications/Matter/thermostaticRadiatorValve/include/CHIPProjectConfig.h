...
#define CHIP_DEVICE_CONFIG_DEVICE_SOFTWARE_VERSION 65793 // Can't be removed, needed for OTA file generation.
#endif
...
#define CHIP_DEVICE_CONFIG_DEVICE_SOFTWARE_VERSION_STRING "1.1.1" // Can't be removed, needed for OTA file generation.
#endif

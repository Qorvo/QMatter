...
#define GP_VERSIONINFO_APP                                         UMB_QPG6105DK_B01_nrt_flash_ext_secure
...
/*
 * Component: gpExtStorage
 */

/* Enable write primitives */
#define GP_EXTSTORAGE_DIVERSITY_WRITE_DISABLE
...
/* Use an external storage device to store the OTA image */
#define GP_UPGRADE_DIVERSITY_USE_EXTSTORAGE

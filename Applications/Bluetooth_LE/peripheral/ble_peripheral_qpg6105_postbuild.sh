...
"$PYTHON" "${SCRIPT_DIR}"/../../..//Tools/Ota/generate_ble_ota_img.py --compression lzma --in_file "${SCRIPT_DIR}"/../../../Work/ble_peripheral_qpg6105/ble_peripheral_qpg6105.hex --out_file "${SCRIPT_DIR}"/../../../Work/ble_peripheral_qpg6105/ble_peripheral_qpg6105 --pem_file_path "${SCRIPT_DIR}"/../../../Tools/Ota/example_private_key.pem.example --pem_password test1234 --sign --sw_ver 1.0.0.0

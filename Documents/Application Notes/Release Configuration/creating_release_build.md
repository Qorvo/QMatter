...
In the sections below we will first describe how to move to a configuration that is intended for production builds for your applications. In a second section we will give a detailed description of the configurations that are relevant for debug and release configurations.

...
#define GP_COM_COMM_ID_COMMAND_UART1    (GP_COM_COMM_ID_UART1 | GP_COM_COMM_ID_BLE_COMMAND)
#define GP_COM_COMM_ID_COMMAND_UART2    (GP_COM_COMM_ID_UART2 | GP_COM_COMM_ID_BLE_COMMAND)
#define GP_COM_COMM_ID_DATA_UART1       (GP_COM_COMM_ID_UART1 | GP_COM_COMM_ID_BLE_DATA)
#define GP_COM_COMM_ID_DATA_UART2       (GP_COM_COMM_ID_UART2 | GP_COM_COMM_ID_BLE_DATA)
#define GP_COM_COMM_ID_ISODATA_UART1    (GP_COM_COMM_ID_UART1 | GP_COM_COMM_ID_BLE_ISODATA)
#define GP_COM_COMM_ID_ISODATA_UART2    (GP_COM_COMM_ID_UART2 | GP_COM_COMM_ID_BLE_ISODATA)
#define GP_COM_COMM_ID_EVENT_UART1      (GP_COM_COMM_ID_UART1 | GP_COM_COMM_ID_BLE_EVENT)
#define GP_COM_COMM_ID_EVENT_UART2      (GP_COM_COMM_ID_UART2 | GP_COM_COMM_ID_BLE_EVENT)

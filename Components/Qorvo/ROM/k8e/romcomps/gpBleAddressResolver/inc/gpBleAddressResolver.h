...
gpHci_Result_t gpBleAddressResolver_AddSpecialFilterAcceptListAddress(gpHci_WhitelistAddressType_t addressType, BtDeviceAddress_t* pAddress, UInt8 stateMask);
gpHci_Result_t gpBleAddressResolver_RemoveSpecialFilterAcceptListAddress(gpHci_WhitelistAddressType_t addressType, BtDeviceAddress_t* pAddress);
UInt8 gpBleAddressResolver_GetFilterAcceptListEntryIndex(gpHci_WhitelistAddressType_t addressType, BtDeviceAddress_t* pAddress);
...
// Adding for backwards compatibility with BLE Host Stack
#define gpBle_LeClearWhiteList gpBle_LeClearFilterAcceptList

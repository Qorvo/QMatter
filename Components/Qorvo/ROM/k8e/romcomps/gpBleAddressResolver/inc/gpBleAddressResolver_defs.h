...
#define BLE_MAX_NR_OF_WHITELIST_ENTRIES                 (GP_HAL_BLE_MAX_NR_OF_FILTER_ACCEPT_LIST_ENTRIES - (GP_HAL_BLE_MAX_NR_OF_WL_CONTROLLER_SPECIFIC_ENTRIES - NUMBER_OF_SPECIAL_ENTRIES_SUBTRACTED_BY_ROM))
...
gpHci_Result_t Ble_AddFilterAcceptListEntry(gpHci_WhitelistAddressType_t addressType, BtDeviceAddress_t* pAddress, UInt8 stateMask, UInt8 rangeStart, UInt8 rangeStop);
gpHci_Result_t Ble_RemoveFilterAcceptListEntry(gpHci_WhitelistAddressType_t addressType, BtDeviceAddress_t* pAddress, UInt8 rangeStart, UInt8 rangeStop);

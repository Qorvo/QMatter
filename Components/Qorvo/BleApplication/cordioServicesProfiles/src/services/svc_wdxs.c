...
#define WDXS_SEC_PERMIT_READ SVC_SEC_PERMIT_READ
#endif

/*! Characteristic write permissions */
#ifndef WDXS_SEC_PERMIT_WRITE
#define WDXS_SEC_PERMIT_WRITE SVC_SEC_PERMIT_WRITE
#endif
...
static const attsAttr_t wdxsList[] =
{
  ...
  /* WDX Device Configuration CCCD */
  {
    ...
    ATTS_SET_CCC,
    (WDXS_SEC_PERMIT_READ | WDXS_SEC_PERMIT_WRITE)
  },
  /* WDX File Transfer Control Characteristic Declaration */
  {
    attChUuid,

...
#ifndef DIS_SEC_PERMIT_WRITE
#define DIS_SEC_PERMIT_WRITE SVC_SEC_PERMIT_WRITE
#endif
/**************************************************************************************************
 Service variables
**************************************************************************************************/
...
static uint8_t disValMfr[DIS_MAXSIZE_MFR_ATT] = DEFAULT_MFR_NAME;
static uint16_t disLenMfr = DEFAULT_MFR_NAME_LEN;
...
static uint8_t disValSid[DIS_SIZE_SID_ATT] = {0x01, 0x02, 0x03, 0x04, 0x05, UINT16_TO_BYTE0(HCI_ID_QORVO), UINT16_TO_BYTE1(HCI_ID_QORVO), 0x00};
...
static uint8_t disValMn[DIS_MAXSIZE_MN_ATT] = DEFAULT_MODEL_NUM;
static uint16_t disLenMn = DEFAULT_MODEL_NUM_LEN;
...
static uint8_t disValSn[DIS_MAXSIZE_SN_ATT] = DEFAULT_SERIAL_NUM;
static uint16_t disLenSn = DEFAULT_SERIAL_NUM_LEN;
...
static uint8_t disValFwr[DIS_MAXSIZE_FWR_ATT] = DEFAULT_FW_REV;
static uint16_t disLenFwr = DEFAULT_FW_REV_LEN;
...
static uint8_t disValHwr[DIS_MAXSIZE_HWR_ATT] = DEFAULT_HW_REV;
static uint16_t disLenHwr = DEFAULT_HW_REV_LEN;
...
static uint8_t disValSwr[DIS_MAXSIZE_SWR_ATT] = DEFAULT_SW_REV;
static uint16_t disLenSwr = DEFAULT_SW_REV_LEN;
...
static uint8_t disValPnpId[DIS_SIZE_PNP_ID_ATT] =
{
    /* Vendor ID source */
    DEFAULT_VENDOR_ID_SRC,

    /* Vendor ID */
    UINT16_TO_BYTE0(DEFAULT_VENDOR_ID), UINT16_TO_BYTE1(DEFAULT_VENDOR_ID),

    /* Product ID */
    UINT16_TO_BYTE0(DEFAULT_PRODUCT_ID), UINT16_TO_BYTE1(DEFAULT_PRODUCT_ID),

    /* Product version */
    UINT16_TO_BYTE0(DEFAULT_PRODUCT_VERSION), UINT16_TO_BYTE1(DEFAULT_PRODUCT_VERSION),
};

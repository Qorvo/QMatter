...
#define DIS_MAXSIZE_SWR_ATT         24  /*!< \brief Size of software revision string attribute */
#endif
...
#ifndef DIS_SIZE_PNP_ID_ATT
#define DIS_SIZE_PNP_ID_ATT         7   /*!< \brief Size of PnP data attribute */
#endif
/**@}*/

...
#define gpHci_processIsoData_CmdId                                   0x04 /*04*/
...
#define gpBle_ReadConnectionAcceptTimeout_CmdId                      0x-1 /*-1*/
#define gpBle_WriteConnectionAcceptTimeout_CmdId                     0x-1 /*-1*/
#define gpBle_ReadTransmitPowerLevel_CmdId                           0x-1 /*-1*/
#define gpBle_ConfigureDataPath_CmdId                                0x-1 /*-1*/
...
#define gpBle_ReadLocalSupportedCodecs_CmdId                         0x-1 /*-1*/
#define gpBle_ReadLocalSupportedCodecCapabilities_CmdId              0x-1 /*-1*/
#define gpBle_ReadLocalSupportedControllerDelay_CmdId                0x-1 /*-1*/
...
#define gpBle_LeReadFilterAcceptListSize_CmdId                              0x-1 /*-1*/
#define gpBle_LeClearFilterAcceptList_CmdId                                 0x-1 /*-1*/
#define gpBle_LeAddDeviceToFilterAcceptList_CmdId                           0x-1 /*-1*/
#define gpBle_LeRemoveDeviceFromFilterAcceptList_CmdId                      0x-1 /*-1*/
...
#define gpBle_LeEnableEncryption_CmdId                               0x-1 /*-1*/
...
#define gpBle_LeReadBufferSize_v2_CmdId                              0x-1 /*-1*/
#define gpBle_LeSetCigParameters_CmdId                               0x-1 /*-1*/
#define gpBle_LeSetCigParametersTest_CmdId                           0x-1 /*-1*/
#define gpBle_LeCreateCis_CmdId                                      0x-1 /*-1*/
#define gpBle_LeRemoveCig_CmdId                                      0x-1 /*-1*/
#define gpBle_LeAcceptCisRequest_CmdId                               0x-1 /*-1*/
#define gpBle_LeRejectCisRequest_CmdId                               0x-1 /*-1*/
#define gpBle_LeSetupIsoDataPath_CmdId                               0x-1 /*-1*/
#define gpBle_LeRemoveIsoDataPath_CmdId                              0x-1 /*-1*/
#define gpBle_LeReadIsoLinkQuality_CmdId                             0x-1 /*-1*/
#define gpBle_LeReadIsoTxSync_CmdId                                  0x-1 /*-1*/
#define gpBle_LeIsoTxTest_CmdId                                      0x-1 /*-1*/
#define gpBle_LeIsoRxTest_CmdId                                      0x-1 /*-1*/
#define gpBle_LeIsoReadTestCounters_CmdId                            0x-1 /*-1*/
#define gpBle_LeIsoTestEnd_CmdId                                     0x-1 /*-1*/
#define gpBle_LeSetHostFeature_CmdId                                 0x-1 /*-1*/
...
#define gpBle_VsdGetRtMgrVersion_CmdId                               0x-1 /*-1*/
...
#define gpHci_SendHciIsoDataFrameToHost_CmdId                        0x5a /*90*/

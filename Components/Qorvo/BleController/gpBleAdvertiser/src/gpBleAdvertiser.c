 ...
 *
 * $Header: //depot/release/Embedded/Components/Qorvo/BleController/v2.10.2.0/comps/gpBleAdvertiser/src/gpBleAdvertiser.c#1 $
 * $Change: 187624 $
...
gpHci_Result_t gpBleAdvertiser_SetVsdAdvEventPriority(UInt16 priority)
{
    ...
    {
        BleAdvertiser_EventPriority = (UInt8)priority;
        BleHdcAdvertiser_EventPriority = (UInt8)priority;
    }
    return gpHci_ResultSuccess;
}

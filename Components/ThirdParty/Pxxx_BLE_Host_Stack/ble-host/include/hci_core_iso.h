...
extern const hciCoreCig_t hciCoreCig[HCI_MAX_CIG_COUNT];

/*! \brief  CIS control blocks. */
extern const hciCoreCis_t hciCoreCis[HCI_MAX_CIS_COUNT];

/*! \brief  BIG control blocks. */
extern const hciCoreBig_t hciCoreBig[HCI_MAX_BIG_COUNT];

/*! \brief  BIS control blocks. */
extern const hciCoreBis_t hciCoreBis[HCI_MAX_BIS_COUNT];
 ...
 */
/*************************************************************************************************/
bool_t hciSendIsoData(uint16_t handle, uint16_t len, uint8_t *pData);

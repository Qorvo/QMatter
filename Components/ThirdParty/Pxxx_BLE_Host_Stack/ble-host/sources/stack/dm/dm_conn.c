...
/*************************************************************************************************/
/*!
 *  \fn     DmDisableSlaveLatency
 *
 *  \brief  Disable or Enable Slave Latency in controller
 *
 *  \param  connId      Connection identifier.
 *  \param  disabled    SL disabled (true) or enabled (false)
 *
 */
/*************************************************************************************************/
void DmDisableSlaveLatency(dmConnId_t connId, bool_t disabled)
{
  ...
  if (pCcb != NULL)
  {
    HciVsdDisableSlaveLatency(pCcb->handle, disabled);
  }
}

/*************************************************************************************************/
/*!
 *  \fn     DmOverruleRemoteMaxRxOctetsAndTime
 *
 *  \brief  overrule the Max Rx Octets and Max Rx Time of the remote peripheral
 *
 *  \param  connId      Connection identifier.
...
void DmOverruleRemoteMaxRxOctetsAndTime(dmConnId_t connId, uint16_t maxRxOctetsRemote, uint16_t maxRxTimeRemote)
{
  ...
  if (pCcb != NULL)
  {
    HciVsdOverruleRemoteMaxRxOctetsAndTime(pCcb->handle, maxRxOctetsRemote, maxRxTimeRemote);
  }
}

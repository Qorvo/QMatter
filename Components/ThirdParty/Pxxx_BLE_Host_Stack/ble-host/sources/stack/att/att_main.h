...
#define ATT_CCB_STATUS_CTX_TIMEOUT    (1<<2)        /* ATT client transaction timed out */
#define ATT_CCB_STATUS_STX_TIMEOUT    (1<<3)        /* ATT server transaction timed out */
#define ATT_CCB_STATUS_RSP_PENDING    (1<<4)        /* ATTS write rsp pending */
#define ATT_CCB_STATUS_CNF_PENDING    (1<<5)        /* ATTC confirm pending */
#define ATT_CCB_STATUS_CONTEXT_LOCK   (1<<6)        /* Slot held until API is processed in ATT */

 ...
 *
 * $Header: //depot/release/Embedded/Components/ThirdParty/ARM/cordio-r20-05/v1.6.3.1/comps/qorvoBleHost/src/cordioBleHost_Hci.c#1 $
 * $Change: 189048 $
...
static void BleHost_ResetSequence(gpHci_CommandCompleteParams_t* pBuf)
{
    ...
    switch (pBuf->opCode)
    {
      ...
      case gpHci_OpCodeLeReadWhiteListSize:
        hciCoreCb.whiteListSize = pBuf->returnParams.whiteListSize;
...
Bool gpHci_VsdMetaWhiteListModifiedEvent(gpHci_VsdMetaWhiteListModified_t* whiteListModifiedParams)
{
